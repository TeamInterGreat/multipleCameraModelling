...
img = [0]*4
img[0] = scale(cv2.imread('/mnt/4A86C22586C2117D/Projects/CCTV/set1/img1.jpg',cv2.IMREAD_COLOR),30)
img[1] = scale(cv2.imread('/mnt/4A86C22586C2117D/Projects/CCTV/set1/img2.jpg',cv2.IMREAD_COLOR),20)
img[2] = scale(cv2.imread('/mnt/4A86C22586C2117D/Projects/CCTV/set1/img3.jpg',cv2.IMREAD_COLOR),30)
img[3] = scale(cv2.imread('/mnt/4A86C22586C2117D/Projects/CCTV/set1/img4.jpg',cv2.IMREAD_COLOR),30)
